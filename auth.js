...
// function initCB(clientSecretFile, callback) {
...
function init(pathToclientSecretFile) {
  return new Promise( (resolve, reject) => {
    // Load client secrets from a local file.
    fs.readFile(pathToclientSecretFile, function processClientSecrets(err, content) {
      if (err) {
        console.log('Error loading client secret file: ' + err);
        reject(err);
        return;
